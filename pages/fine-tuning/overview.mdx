---
title: "Qubex LLM Fine-Tuning"
description: "Qubex LLM Fine-Tuning Overview"
---

import { Cards, Callout } from "nextra/components";
import Image from "next/image";

# Qubex LLM Fine-Tuning

Fine-tuning is now available in Qubex LLM as an additional opt-in feature to improve your baseline model responses. Fine-tuning can be a powerful
way to "bake in" knowledge that is specific to your use case into an already great foundational model like LLama 3 8B.

## Why fine-tune?

Fine-tuning and LLM is taking a solid foundational model and improving or "tuning" its behavior, responses, or inherit knowledge based on your Qubex LLM chats and documents.
...
When you order a fine-tuned model via Qubex LLM we **will deliver to you via email** a link to download an 8-bit quantized `.GGUF` file that you can run _anywhere_ you run
LLMs locally. You can load this model directly into Qubex LLM, Ollama, LMStudio, LocalAI, and anywhere else you can run GGUF files.
...
<Cards>
  <Card title="Cloud Fine-Tuning" href="/fine-tuning/cloud-fine-tuning">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Cloud Fine-Tuning"
    />
  </Card>
  <Card title="Local Fine-Tuning" href="/fine-tuning/local-fine-tuning">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Local Fine-Tuning"
    />
  </Card>
</Cards>
