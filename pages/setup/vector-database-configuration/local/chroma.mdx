...
<Image
  src="/images/Qubex LLM-setup/vector-database-configuration/local/chroma/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
Qubex LLM can connect to your local or cloud-hosted Chroma instance running so that Qubex LLM can store and search embeddings on it automatically.
...
<Callout type="warning" emoji="️⚠️">
  **Developer Notice**
    ...
    Qubex LLM will use the embedding model set and **will not** use Chroma's built-in embedders even if defined.
...
<Image
  src="/images/Qubex LLM-setup/vector-database-configuration/local/chroma/chroma-vectordb.png"
  height={1080}
  width={1920}
  quality={100}
