...
<Image
  src="/images/Qubex LLM-setup/vector-database-configuration/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
<Callout type="error" emoji="️‼️">
  **Caution!**
    ...
    You should prevent "hopping" between vector databases. Qubex LLM will not automatically port over your already embedded information.
