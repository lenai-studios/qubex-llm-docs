...
description: "This guide explain how to setup AI Agents on Qubex LLM"
---
...
<Image
  src="/images/Qubex LLM-setup/agent-configuration/configuration-menu.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Qubex LLM Agent Configuration Menu"
/>
...
<Image
  src="/images/Qubex LLM-setup/agent-configuration/llm.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Qubex LLM Agent LLM"
/>

After updating the workspace agent settings, click the "Configure Agent Skills" button.

<Image
  src="/images/Qubex LLM-setup/agent-configuration/configure-agent-skills-button.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Qubex LLM Agent LLM"
...
<Callout type="info" emoji="️ℹ️">
  **Note**
    ...
    Qubex LLM supports a lot of LLM providers for use with `@agent`s and you can see all the supported LLMs from [here](https://docs.Qubex LLM.com/features/language-models#supported-language-model-providers)
...
<Image
  src="/images/Qubex LLM-setup/agent-configuration/tools.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Qubex LLM Agent Skills"
/>
...
<Image
  src="/images/Qubex LLM-setup/agent-configuration/search.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Qubex LLM Agent Web Browsing"
/>

With Google Search Engine you can perform up to 100 search for free everyday.

**That's it! You can now use Qubex LLM's Agents!**
