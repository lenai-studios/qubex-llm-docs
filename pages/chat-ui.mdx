...
description: "Learn how the basics of chatting in Qubex LLM"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM Chat UI"
/>

# Overview of the chat interface

The chat interface of Qubex LLM is where you will spend most of your time when using Qubex LLM, as such you should familiarize yourself with the basics. This page could have some additional
icons that are not in the above image, as we are always improving Qubex LLM.
...
- Feedback (Thumbs Up & Thumbs Down): Allow the user to leave qualitative feedback on an LLM response. Leaving feedback **has no impact on message history or future responses**. Feedback metrics are most useful for [exporting of chats](/features/chat-logs) to be able to sort through good responses for creating fine-tunes outside of Qubex LLM.
...
- Font Size: Set the default font size for your profile of Qubex LLM.
