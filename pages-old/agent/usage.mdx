...
description: "How to use AI Agents on Qubex LLM"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Trigger"
/>
...
You can use RAG search by asking the agent something like `@agent can you check what you already know about Qubex LLM?`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents RAG Search"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Web Browsing"
/>
...
Example: `@agent can you scrape the website Qubex LLM.com and give me a summary of features Qubex LLM have?`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Web Scraping"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Save Files"
/>

<Callout type="info" emoji="️💡">
  **Note**

    Qubex LLM will show you an popup to choose the file location and file name to save the file.
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents List Documents"
/>
...
Example: `@agent can you summarize the content on https://docs.Qubex LLM.com/features/chat-logs`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Summarize Documents"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents Chart Generation"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM AI Agents SQL Agent skill"
/>
...
This is because of the LLM you are using, not all LLMs are great of even useable for `tool-calling`. With Qubex LLM we make every model possible to be used as an agent, but the strength of your model to comprehend the instruction and examples of tool calling is still reliant on the model itself. Smaller models with 4-Bit Quantization won't respond properly as an agent most times, but the very same model at 8Bit Quantization will give better response as an Agent -- same LLM but different quantization. If your agent is not responding properly then try using a higher quantization model or a larger model altoghether.
