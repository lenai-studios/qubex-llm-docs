---
title: "502 Error on Qubex LLM Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of Qubex LLM and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted Qubex LLM!
...
<Image
  ...
  width={500}
  quality={100}
  alt="Qubex LLM Subscription Item"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Qubex LLM Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Qubex LLM Subscription Reboot"
/>
...
- [Switch to a cloud based embedder](/Qubex LLM-setup/embedder-configuration/overview#cloud-model-providers)
