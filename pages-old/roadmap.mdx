---
title: "Roadmap"
description: "Feature & product roadmap for Qubex LLM Docker & Desktop"
---
...
At Qubex LLM, we're dedicated to making the most advanced LLM application available to everyone. We want to empower everyone to be able leverage LLMs for their own use for both non-technical and technical users.
...
- [~] The Qubex LLM Community Hub (sharing plugins, prompts, workspaces, etc.)
  - [ ] Private Qubex LLM Hub (sharing workspaces, prompts, plugins, etc. but private)
...
- [ ] Simplified Token Tracking and monitoring sub-service (simple SDK that will be included in Qubex LLM Desktop & Docker)
