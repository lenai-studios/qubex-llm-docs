...
<Image
  ...
  width={1920}
  quality={100}
  alt="Qubex LLM Vector Databases"
/>

# Vector Databases

Qubex LLM comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave Qubex LLM when using the default option.

Qubex LLM supports many vector databases providers out of the box.
