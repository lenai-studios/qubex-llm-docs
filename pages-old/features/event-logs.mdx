...
The Event Logs page in Qubex LLM allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your Qubex LLM instance.
