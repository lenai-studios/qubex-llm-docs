---
title: "All Features"
description: "All the features of Qubex LLM"
---
...
<Cards>
  ...
  <Card title="Embedded Chat Widgets" href="chat-widgets">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Embedded Chat Widgets"
    />
  </Card>
  ...
  <Card title="Large Language Models" href="language-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Large Language Models"
    />
  </Card>
  <Card title="Embedding Models" href="embedding-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Embedding Models"
    />
  </Card>
  <Card title="Transcription Models" href="transcription-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Transcription Models"
    />
  </Card>
  ...
  <Card title="Privacy & Data Handling" href="privacy-and-data-handling">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Privacy & Data Handling"
    />
  </Card>
  <Card title="Cloud Deployment" href="/installation-docker/cloud-docker">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Qubex LLM Cloud Deployment"
    />
  </Card>
</Cards>
