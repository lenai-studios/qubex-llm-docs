...
description: "Qubex LLM allows you to use a host of LLM providers for chatting and generative AI."
---
...
Qubex LLM allows you to use a host of LLM providers for chatting and generative AI.
...
<Card title="KobaldCPP" href="https://github.com/LostRuins/koboldcpp">
  ...
  <Card title="OpenAI (generic)" href="/Qubex LLM-setup/llm-configuration/cloud/openai-generic"> 
    <Image
      src="/images/features/language-models/openai.png" 
      height={1080} 
      width={1920} 
