...
description: "Qubex LLM offers two main ways to use Qubex LLM. There are some distinct differences in functionality between each offering"
---
...
Qubex LLM Docker is both a **single-user** and **multi-user** application you can install on any webserver using docker and leverage local LLMs, RAG, and Agents with little to zero configuration and full privacy.

Self hosting Qubex LLM via Docker is very popular and can be done locally or on cloud servicers (aws, google cloud, railway etc..).
